...
public class WeeklyRankingJobConfig {
    ...
    private static final String STEP_NAME = "weeklyAggregationStep";
    ...
    private final WeeklyMetricsReader weeklyMetricsReader;
    private final RankingProcessor rankingProcessor;
    private final WeeklyRankWriter weeklyRankWriter;
