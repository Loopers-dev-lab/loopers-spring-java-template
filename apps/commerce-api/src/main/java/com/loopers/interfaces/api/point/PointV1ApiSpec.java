...
public interface PointV1ApiSpec {
     ...
     *
     * @param userId the identifier of the user whose points are being retrieved
     * @return an ApiResponse containing a PointResponse with the user's total points and related metadata
     */
    @Operation(
            summary = "포인트 조회",
    ...
    /**
     * Charge points for a user and return the updated point balance.
     *
     * @param userId the ID of the user
     * @param request the charge request payload containing the amount and related data
     * @return an ApiResponse containing the user's updated PointResponse
     */
    @Operation(
            summary = "포인트 충전",
