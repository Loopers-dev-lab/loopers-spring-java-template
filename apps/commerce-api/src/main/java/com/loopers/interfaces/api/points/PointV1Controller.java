...
public class PointV1Controller implements PointV1ApiSpec {
    ...
    /**
     * Retrieve the authenticated member's point balance.
     *
     * @param userId the value of the "X-USER-ID" request header identifying the member
     * @return an ApiResponse wrapping a PointV1Dto.PointResponse that contains the member's current points
     * @throws CoreException if the "X-USER-ID" header is missing or blank (ErrorType.MISSING_REQUEST_HEADER)
     */
    @GetMapping
    @Override
