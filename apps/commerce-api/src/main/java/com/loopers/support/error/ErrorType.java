...
public enum ErrorType {
    ...
    INVALID_ORDER_AMOUNT_MISMATCH(HttpStatus.BAD_REQUEST, "INVALID_ORDER_AMOUNT_MISMATCH", "주문 금액이 일치하지 않습니다."),

    /** Payment 도메인 에러 */
    INVALID_PAYMENT_ORDER_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_ORDER_EMPTY", "주문은 비어있을 수 없습니다."),
    INVALID_PAYMENT_USER_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_USER_EMPTY", "사용자는 비어있을 수 없습니다."),
    INVALID_PAYMENT_CARD_TYPE_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_CARD_TYPE_EMPTY", "카드 종류는 비어있을 수 없습니다."),
    INVALID_PAYMENT_CARD_NO_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_CARD_NO_EMPTY", "카드 번호는 비어있을 수 없습니다."),
    INVALID_PAYMENT_AMOUNT_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_AMOUNT_EMPTY", "결제 금액은 비어있을 수 없습니다."),
    INVALID_PAYMENT_AMOUNT_NOT_POSITIVE(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_AMOUNT_NOT_POSITIVE", "결제 금액은 0보다 커야 합니다."),
    INVALID_PAYMENT_REQUESTED_AT_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_REQUESTED_AT_EMPTY", "결제 요청 시각은 비어있을 수 없습니다."),
    PAYMENT_ALREADY_COMPLETED(HttpStatus.BAD_REQUEST, "PAYMENT_ALREADY_COMPLETED", "이미 완료된 결제입니다."),
    PAYMENT_CANNOT_MARK_PENDING(HttpStatus.BAD_REQUEST, "PAYMENT_CANNOT_MARK_PENDING", "REQUESTED 상태에서만 PENDING으로 변경할 수 있습니다."),
    PAYMENT_CANNOT_MARK_REQUEST_FAILED(HttpStatus.BAD_REQUEST, "PAYMENT_CANNOT_MARK_REQUEST_FAILED", "REQUESTED 상태에서만 REQUEST_FAILED로 변경할 수 있습니다."),
    PAYMENT_NOT_PENDING(HttpStatus.BAD_REQUEST, "PAYMENT_NOT_PENDING", "PENDING 상태에서만 결제 결과를 처리할 수 있습니다."),
    INVALID_PAYMENT_STATUS(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_STATUS", "유효하지 않은 결제 상태입니다."),
    PG_REQUEST_FAILED(HttpStatus.SERVICE_UNAVAILABLE, "PG_REQUEST_FAILED", "PG 요청에 실패했습니다."),
    PAYMENT_NEEDS_MANUAL_REFUND(HttpStatus.INTERNAL_SERVER_ERROR, "PAYMENT_NEEDS_MANUAL_REFUND", "수동 환불이 필요합니다."),

    /** CouponPolicy 도메인 에러 */
    INVALID_COUPON_POLICY_DISCOUNT_TYPE_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_DISCOUNT_TYPE_EMPTY", "할인 타입은 비어있을 수 없습니다."),
    INVALID_COUPON_POLICY_DISCOUNT_AMOUNT_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_DISCOUNT_AMOUNT_EMPTY", "정액 할인 금액은 비어있을 수 없습니다."),
    INVALID_COUPON_POLICY_DISCOUNT_RATE_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_DISCOUNT_RATE_EMPTY", "정률 할인율은 비어있을 수 없습니다."),
    INVALID_COUPON_POLICY_DISCOUNT_RATE_RANGE(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_DISCOUNT_RATE_RANGE", "할인율은 0 초과 1 이하여야 합니다."),

    /** Coupon 도메인 에러 */
    INVALID_COUPON_USER_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_COUPON_USER_EMPTY", "쿠폰 소유자는 비어있을 수 없습니다."),
    INVALID_COUPON_POLICY_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_EMPTY", "쿠폰 정책은 비어있을 수 없습니다."),
    ...
    COUPON_NOT_USED(HttpStatus.BAD_REQUEST, "COUPON_NOT_USED", "사용된 쿠폰만 복구할 수 있습니다.");
