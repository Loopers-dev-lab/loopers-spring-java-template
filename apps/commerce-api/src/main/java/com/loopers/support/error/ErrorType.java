...
public enum ErrorType {
    ...
    INVALID_PAYMENT_INFO_EMPTY(HttpStatus.BAD_REQUEST, "INVALID_PAYMENT_INFO_EMPTY", "PG 결제가 필요하지만 결제 정보가 없습니다."),
    ...
    INVALID_COUPON_POLICY_DISCOUNT_RATE_SCALE(HttpStatus.BAD_REQUEST, "INVALID_COUPON_POLICY_DISCOUNT_RATE_SCALE", "할인율은 소수점 4자리까지만 허용됩니다."),
