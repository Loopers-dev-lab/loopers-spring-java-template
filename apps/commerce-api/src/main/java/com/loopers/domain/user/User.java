...
public class User extends BaseEntity {
    ...
    protected void guard() {
        ...
        if(loginId == null || loginId.isBlank()) {
            ...
            throw new CoreException(ErrorType.BAD_REQUEST, "User : ID에 영문과 숫자만 10자 이내로 꼭 포함되어 있어야 합니다.");
        }
        ...
        if(email == null || email.isBlank()) {
            ...
            throw new CoreException(ErrorType.BAD_REQUEST, "User : email이 `xx@yy.zz` 형식에 맞아야 합니다.");
        }
        ...
        if(birthday == null || birthday.isBlank()) {
            ...
            throw new CoreException(ErrorType.BAD_REQUEST, "User : birthday가 `yyyy-MM-dd` 형식에 맞아야 합니다.");
        }
