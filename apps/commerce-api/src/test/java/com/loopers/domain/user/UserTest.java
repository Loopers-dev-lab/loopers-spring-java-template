...
class UserTest {
    ...
    class Create {
        ...
        void ID_누락시_생성에_실패한다() {
            assertThatThrownBy(() -> User.create(null, VALID_EMAIL, VALID_BIRTH_DATE, VALID_GENDER))
        ...
        void 이메일_누락시_생성에_실패한다() {
            assertThatThrownBy(() -> User.create(VALID_ID, null, VALID_BIRTH_DATE, VALID_GENDER))
                    .isInstanceOf(CoreException.class)
        ...
        void 생년월일_누락시_생성에_실패한다() {
            assertThatThrownBy(() -> User.create(VALID_ID, VALID_EMAIL, null, VALID_GENDER))
                    .isInstanceOf(CoreException.class)
        ...
        void 필수값이_있으면_생성에_성공한다() {
            assertDoesNotThrow(() ->
                    User.create(VALID_ID, VALID_EMAIL, VALID_BIRTH_DATE, VALID_GENDER)
            );
        }
        ...
        void ID_영문_및_숫자_이외_값이_있으면_User_객체_생성에_실패한다(String id) {
            assertThatThrownBy(() -> User.create(id, VALID_EMAIL, VALID_BIRTH_DATE, VALID_GENDER))
                    .isInstanceOf(CoreException.class)
        ...
        void ID_영문_및_숫자_10자_이내_형식에_맞으면_User_객체_생성에_성공한다(String id) {
            assertDoesNotThrow(() ->
                    User.create(id, VALID_EMAIL, VALID_BIRTH_DATE, VALID_GENDER)
            );
        }
        ...
        void 이메일_형식에_맞지_않으면_User_객체_생성에_실패한다(String email) {
            assertThatThrownBy(() -> User.create(VALID_ID, email, VALID_BIRTH_DATE, VALID_GENDER))
                    .isInstanceOf(CoreException.class)
        ...
        void 이메일_형식에_맞으면_User_객체_생성에_성공한다(String email) {
            assertDoesNotThrow(() ->
                    User.create(VALID_ID, email, VALID_BIRTH_DATE, VALID_GENDER)
            );
        }
        ...
        void 생년월일_형식에_맞지_않으면_User_객체_생성에_실패한다(String birthDate) {
            assertThatThrownBy(() -> User.create(VALID_ID, VALID_EMAIL, birthDate, VALID_GENDER))
                    .isInstanceOf(CoreException.class)
        ...
        void 생년월일_형식에_맞으면_User_객체_생성에_성공한다(String birthDate) {
            assertDoesNotThrow(() ->
                    User.create(VALID_ID, VALID_EMAIL, birthDate, VALID_GENDER)
            );
        }
    }
}
