    ...
    class Create {
        ...
        class ValidId {
            ...
            void should_fail_to_create_user_when_id_is_invalid() {
                ...
                // when & then
                assertThatThrownBy(() -> User.create(invalidUserId1, "xx@yy.zz", "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("ID는 영문 및 숫자 10자 이내여야 합니다.");

                assertThatThrownBy(() -> User.create(invalidUserId2, "xx@yy.zz", "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("ID는 영문 및 숫자 10자 이내여야 합니다.");

                assertThatThrownBy(() -> User.create(invalidUserId3, "xx@yy.zz", "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("ID는 영문 및 숫자 10자 이내여야 합니다.");
            }
        }
        ...
        class ValidEmail {
            ...
            void should_fail_to_create_user_when_email_is_invalid() {
                ...
                // when & then
                assertThatThrownBy(() -> User.create("testuser1", invalidEmail1, "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("이메일은 xx@yy.zz 형식이어야 합니다.");

                assertThatThrownBy(() -> User.create("testuser1", invalidEmail2, "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("이메일은 xx@yy.zz 형식이어야 합니다.");

                assertThatThrownBy(() -> User.create("testuser1", invalidEmail3, "1999-01-31"))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("이메일은 xx@yy.zz 형식이어야 합니다.");
            }
        }
        ...
        class ValidBirthDate {
            ...
            void should_fail_to_create_user_when_birth_date_is_invalid() {
                ...
                // when & then
                assertThatThrownBy(() -> User.create("testuser1", "xx@yy.zz", invalidBirthDate1))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("생년월일은 yyyy-MM-dd 형식이어야 합니다.");

                assertThatThrownBy(() -> User.create("testuser1", "xx@yy.zz", invalidBirthDate2))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("생년월일은 yyyy-MM-dd 형식이어야 합니다.");

                assertThatThrownBy(() -> User.create("testuser1", "xx@yy.zz", invalidBirthDate3))
                        .isInstanceOf(IllegalArgumentException.class)
                        .hasMessage("생년월일은 yyyy-MM-dd 형식이어야 합니다.");
            }
        }
