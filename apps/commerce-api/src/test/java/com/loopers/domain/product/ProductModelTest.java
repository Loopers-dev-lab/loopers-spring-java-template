...
class ProductModelTest {
  ...
  class Create_Product {
    ...
    void 성공_Product_객체생성() {
      ...
      assertThat(product.getPrice()).isEqualTo(new BigDecimal(80_000));
  ...
  class Valid_Product {
    ...
    void 실패_가격_음수오류() {
      assertThrows(CoreException.class, () -> {
        product = Product.create(brand, "Wild Faith Rose Sweatshirt", new BigDecimal(-1000), 0);
      });
    }
    ...
    void 실패_재고_음수오류() {
      assertThrows(CoreException.class, () -> {
        product = Product.create(brand, "Wild Faith Rose Sweatshirt", new BigDecimal(80_000), -1);
      });
    }
  ...
  class Valid_재고차감 {
    @BeforeEach
    void setup() {
      product = Product.create(brand, "Wild Faith Rose Sweatshirt", new BigDecimal(1000), 10);
    }
