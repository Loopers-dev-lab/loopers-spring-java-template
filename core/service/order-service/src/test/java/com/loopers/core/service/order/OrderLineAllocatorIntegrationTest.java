    ...
    class 상품_할당 {
        ...
        class 충분한_재고가_있는_경우 {
            ...
            void setUp() {
                ...
                product = productRepository.save(
                        Instancio.of(Product.class)
                                ...
                                .set(field(Product::getName), new ProductName("테스트상품"))
                ...
                orderItem = Instancio.of(OrderItem.class)
                        ...
                        .set(field(OrderItem::getOrderId), new OrderId("1"))
            ...
            void 정확히_남은_재고만큼_할당하면_재고가_0이_된다() {
                ...
                OrderItem exactOrderItem = Instancio.of(OrderItem.class)
                        .set(field(OrderItem::getId), OrderItemId.empty())
                        .set(field(OrderItem::getOrderId), new OrderId("1"))
                        .set(field(OrderItem::getProductId), product.getId())
                        .set(field(OrderItem::getQuantity), new Quantity(100L))
                        .create();
        ...
        class 재고가_부족한_경우 {
            ...
            void 예외를_발생시킨다() {
                // given - 재고보다 많은 수량 주문
                OrderItem largeOrderItem = Instancio.of(OrderItem.class)
                        .set(field(OrderItem::getId), OrderItemId.empty())
                        .set(field(OrderItem::getOrderId), new OrderId("1"))
                        .set(field(OrderItem::getProductId), product.getId())
                        .set(field(OrderItem::getQuantity), new Quantity(150L))
                        .create();
