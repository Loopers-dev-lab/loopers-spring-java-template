...
/**
 * 일간 랭킹 점수 누적 엔티티 (슬라이딩 윈도우)
 * 최근 24시간 동안의 Raw Metrics를 누적하고 current_score를 계산
 */
@Entity
@Table(name = "ranking_score_daily", indexes = {
    @Index(name = "idx_current_score", columnList = "current_score DESC")
})
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@Getter
public class RankingScoreDaily {
    ...
    @Builder
    private RankingScoreDaily(Long productId, BigDecimal totalOrderAmount, Long totalLikeCount,
